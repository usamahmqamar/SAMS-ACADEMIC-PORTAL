                                      ...
                                      <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex text-amber-500 font-bold">
                                          ...
                                          {Array.from({ length: 5 - pf.rating }).map((_, idx) => (
                                            <span key={idx} className="text-slate-200">★</span>
                                          ))}
                                        </div>
                                      </div>
                                    ...
                                    <div key={plan.id} className="bg-slate-50 border border-slate-205 rounded-xl p-3.5 space-y-2.5 text-xs relative">
                                      <div className="flex justify-between items-start">
                                        <div>
                                          ...
                                          <span className="block text-[10px] text-slate-400 font-mono mt-0.5">Subject: {plan.subject} • Target: {plan.date}</span>
                                        </div>
                      ...
                      <div className="flex flex-wrap bg-slate-100 p-1 rounded-xl w-fit border border-slate-200/40 gap-1">
                        ...
                        >
                          ...
                          {isTabRestricted('payroll', currentSimulatedRole) && (
                            <span className="text-[10px] bg-amber-100 border border-amber-200 text-amber-800 px-1.5 py-0.5 rounded font-sans scale-90 flex items-center gap-0.5 select-none">🔒 Restrict</span>
                          )}
                        </button>
                        <button
                          type="button"
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
                          ...
                          <div className="flex flex-wrap gap-1 bg-slate-100 p-1 rounded-xl">
                            {[
                              ...
                              { id: 'non-teaching', label: '🛠️ Non-Teaching' },
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {filteredTeachers.length === 0 ? (
                          ...
                          filteredTeachers.map(teacher => {
                            ...
                            if (loadUnits > maxW) {
                              statusText = "🚨 Stress Risk (Overloaded)";
                                  ...
                                  <div className="mt-3 bg-slate-50 rounded-xl p-2.5 text-[11px] grid grid-cols-2 gap-1 font-sans border border-slate-150">
                                    ...
                                    <div>
                                      ...
                                      <span className="font-bold text-slate-800 font-mono">
                                        📈 {teacher.performanceScore || 80}% Reliability
                                      </span>
                                    </div>
                                  </div>
              ...
              {activeTab === 'classes' && (
                <div id="erp-view-classes-hub" className="space-y-6 animate-fade-in">
                  ...
                  <div className="flex border-b border-slate-200 overflow-x-auto whitespace-nowrap scrollbar-none">
                    ...
                    >
                      <span>🏢 Class Allocations &amp; Registries</span>
                    </button>
                    <button
                    ...
                    >
                      <span>🎓 Master Course Syllabus Directory</span>
                    ...
                    >
                      <span>📅 Multi-Week Curriculum Checklists</span>
                    </button>
                    <button
                      ...
                      <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm space-y-4">
                        ...
                        <form onSubmit={handleCreateClass} className="space-y-3">
                          ...
                          <div>
                            ...
                            >
                              {(!activeSaaSSchool || activeSaaSSchool.sectionsEnabled?.nursery) && <option value="nursery">👶 Nursery Wing</option>}
                              {(!activeSaaSSchool || activeSaaSSchool.sectionsEnabled?.primary) && <option value="primary">🏫 Primary Wing</option>}
                              {(!activeSaaSSchool || activeSaaSSchool.sectionsEnabled?.secondary) && <option value="secondary">🎓 Junior Secondary Wing</option>}
                              {(!activeSaaSSchool || activeSaaSSchool.sectionsEnabled?.islamia) && <option value="islamia">🌙 Islamia Wing</option>}
                            </select>
                          </div>
                        ...
                        <div className="space-y-5">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-1">
                              <span className="text-[11px] font-bold text-indigo-750 uppercase tracking-wider">👶 Nursery Wing</span>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-1">
                              <span className="text-[11px] font-bold text-amber-700 uppercase tracking-wider">🏫 Primary Wing</span>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-1">
                              <span className="text-[11px] font-bold text-rose-700 uppercase tracking-wider">🎓 Junior Secondary Wing</span>
                            ...
                            {isEditingClass ? (
                              <div className="space-y-4 animate-fade-in font-sans">
                                <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                                  <span className="text-xs font-bold text-indigo-700 uppercase tracking-wider">✏️ Modify Class Parameters</span>
                  ...
                  {classesSubTab === 'subjects' && (
                    <div className="space-y-6 animate-fade-in font-sans">
                      <div className="bg-gradient-to-r from-teal-50 via-slate-50 to-indigo-50 text-slate-900 rounded-3xl p-6 border border-indigo-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="space-y-1">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-slate-505 text-xs font-mono">• Session-Wide Subject Directory</span>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
                          <p className="text-xs text-slate-500 font-medium font-sans">🐣 Nursery Wing Subjects</p>
                          <p className="text-2xl font-bold text-rose-600 mt-1 font-mono">{subjects.filter(s => s.level === 'nursery').length}</p>
                        </div>
                        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
                          <p className="text-xs text-slate-500 font-medium font-sans">🏫 Primary Wing Subjects</p>
                          <p className="text-2xl font-bold text-amber-600 mt-1 font-mono">{subjects.filter(s => s.level === 'primary').length}</p>
                        </div>
                        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
                          <p className="text-xs text-slate-500 font-medium font-sans">🎓 Junior Secondary Subjects</p>
                            ...
                            <form onSubmit={handleCreateSubject} className="space-y-3">
                              <div>
                                <div className="flex justify-between items-center mb-1">
                                  ...
                                  >
                                    {subjectInputMode === 'preset' ? '✍️ Type Custom' : '📋 Pick Preset'}
                                  </button>
                                </div>
                              ...
                              <div>
                                ...
                                >
                                  <option value="nursery">👶 Nursery Wing (Play &amp; Sensory)</option>
                                  <option value="primary">🏫 Primary Wing (Foundations)</option>
                                  <option value="secondary">🎓 Junior Secondary Wing</option>
                                  <option value="islamia">🌙 Islamia Wing</option>
                                </select>
                              </div>
                          ...
                          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200 border-dashed space-y-3 font-sans">
                            <div className="space-y-1">
                              <h4 className="text-xs font-bold text-slate-800 flex items-center space-x-2">
                                <span>🚀 Rapid Presets Booster</span>
                              </h4>
                            ...
                            <div className="grid grid-cols-1 gap-2 pt-1">
                              ...
                              >
                                <span>🐣 Import Nursery Presets</span>
                              ...
                              <button
                                ...
                                className="bg-white hover:bg-slate-100 border border-slate-205 text-left px-3 py-2 text-xs rounded-xl flex items-center justify-between font-sans transition-colors cursor-pointer"
                              >
                                <span>🏫 Import Primary Presets</span>
                              ...
                              <button
                                ...
                                className="bg-white hover:bg-slate-100 border border-slate-205 text-left px-3 py-2 text-xs rounded-xl flex items-center justify-between font-sans transition-colors cursor-pointer"
                              >
                                <span>🎓 Import Secondary Presets</span>
                              ...
                              <button
                                ...
                                className="bg-white hover:bg-slate-100 border border-slate-205 text-left px-3 py-2 text-xs rounded-xl flex items-center justify-between font-sans transition-colors cursor-pointer"
                              >
                                <span>🌙 Import Islamia Presets</span>
                        ...
                        <div className="lg:col-span-8 bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-4">
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-slate-150 font-sans">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              >
                                <option value="nursery">👶 Nursery (Preschool - K2)</option>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-slate-150 pb-4">
                          <div>
                            <div className="flex flex-wrap items-center gap-1.5">
                              <span className="font-bold text-slate-900 text-sm">{scoreEntryClass} • {scoreEntrySubject}</span>
                              {isApproved ? (
                                ...
                                <span className="bg-amber-100 text-amber-800 border border-amber-250 text-[10px] tracking-wide font-extrabold px-2.5 py-0.5 rounded-full flex items-center gap-1">
                                  🔒 Submitted (Under Board Moderation)
                                </span>
                              ) : (
                                  ...
                                  return (
                                    <tr key={s.id} className="hover:bg-slate-50/50 transition-colors">
                                      <td className="p-3">
                                        ...
                                        <p className="text-[9.5px] text-slate-400 mt-1 font-medium">{s.grade} • Division {s.classSection || 'A'}</p>
                                      </td>
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                onClick={async () => {
                                  ...
                                  alert(`📤 Subject ${scoreEntrySubject} scores submitted for consolidation successfully!`);
                                }}
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  <button
                                    ...
                                    onClick={async () => {
                                      ...
                                      alert(`✅ Entire student list of ${cls.name} has been certified and released!`);
                                    }}
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      ...
                                      alert(`❌ Class records reverted to Draft status successfully.`);
                                    }}
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      alert(`✨ Applied SAMS Board grace marks to borderline students in ${cls.name} relative to a minimum standard score of ${passingPct}%.`);
                                    }}
                                        ...
                                        >
                                              ...
                                              <p className="font-extrabold text-slate-900 text-xs flex items-center gap-1.5">
                                                ...
                                                {hasAwaitingApproval && !isReleased && (
                                                  <span className="px-1.5 py-0.5 rounded text-[8px] uppercase font-mono font-bold bg-amber-100 text-amber-800 border border-amber-200 animate-pulse">
                                                    ⏳ Computed &amp; Awaiting Approval
                                                  </span>
                                                )}
                                              </p>
                                              <p className="text-[9.5px] text-slate-400">Section {s.classSection || 'Master'} • Admission {s.enrollmentNo || `ADM-${s.id.split('-').pop()}`}</p>
                                            </div>
                                          </div>
                                          ...
                                          <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                                            ...
                                            <div onClick={(e) => e.stopPropagation()} className="flex items-center space-x-1.5">
                                              ...
                                              <span className="text-slate-300 font-bold text-xs shrink-0 select-none">{isExpanded ? '▲' : '▼'}</span>
                                            </div>
                                          </div>
                                        </div>
                                                    ...
                                                    return (
                                                      <div key={sub} className="grid grid-cols-12 items-center p-2">
                                                        ...
                                                        <span className="col-span-4 text-[9.5px] text-slate-400 text-center font-mono">
                                                          {subjectStatus === 'Submitted' ? '⚠️ Awaiting Approval' : 'Marks Entry'}
                                                        </span>
                                                ...
                                                <div className="flex justify-between items-center text-[10px]">
                                                  <button
                                                    ...
                                                    onClick={async () => {
                                                      ...
                                                      await saveStudentChanges(updated);
                                                      alert("✨ AI board evaluation successfully updated for " + s.name);
                                                    }}
                            ...
                            <table className="w-full text-left border-collapse table-fixed min-w-[750px]">
                              ...
                              <tbody className="divide-y divide-slate-100 font-medium text-slate-700 text-xs">
                                {classes.filter(c => !c.branch || c.branch === selectedBranch).map(c => {
                                  ...
                                  let statusLabel = '✏️ Under Entry (Draft)';
                        ...
                        <div className="bg-white border rounded-2xl p-5 shadow-sm space-y-4 font-sans">
                          ...
                          <div className="bg-slate-50 border border-slate-200/50 rounded-xl p-3.5 space-y-2 text-[11px] text-slate-650 leading-normal">
                            ...
                            <div className="space-y-1.5 font-sans">
                              <p>🧑‍🎓 <strong>High Attenders (&gt;=90%)</strong> show an overall institutional average GPA of <span className="font-bold text-indigo-750">89.4%</span></p>
                              <p>⚠️ <strong>Frequent Absence (&lt;85%)</strong> correlates with class GPAs slipping down to under <span className="font-bold text-rose-700">67.1%</span></p>
                            </div>
                          </div>
                        </div>
                                  ...
                                  <div className="space-y-4 font-sans text-xs">
                                    <div>
                                      <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-705 block border-b pb-1 font-sans flex items-center justify-between">
                                        <span>📝 Standard Secular Schooling Results</span>
                                        {reportStudent.level !== 'nursery' && (
                                    ...
                                    <div className="text-[10px] leading-relaxed text-indigo-950/80 font-sans">
                                      {reportStudent.attendancePercentage >= 90 ? (
                                        <p className="bg-emerald-50 text-emerald-800 p-2 rounded border border-emerald-100">
                                          💡 Positive Attendance Correlation: Excellent academic presence supports healthy score metrics compilation.
                                        </p>
                                      ) : (
                                        <p className="bg-amber-50 text-amber-800 p-2 rounded border border-amber-100 font-medium">
                                          ⚠️ Attendance Alert impact: Frequent absences slip student position indexes and require tutoring review.
                                        </p>
                                      )}
                                    </div>
                                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border-t border-slate-100 pt-3 mt-1.5 space-y-2">
                          ...
                          >
                            ...
                            <span>✨ Smart Auto-Assign Plan</span>
                          </button>
                      ...
                      {(currentSimulatedRole === 'Super Admin' || currentSimulatedRole === 'Branch Admin') && (
                        <div className="bg-indigo-50/70 border border-indigo-150 p-4 rounded-xl space-y-3 shadow-xs">
                          <div className="flex items-center space-x-1.5 text-indigo-950 font-bold text-xs">
                            ...
                            <span>👑 Admin Direct Inspection Desk</span>
                          </div>
                          ...
                          <div className="space-y-1 w-full">
                            ...
                            >
                              ...
                              {students.map(s => (
                                <option key={s.id} value={s.id}>
                                  {s.name} ({s.grade}) — Parent: {s.parentEmail}
                                </option>
                              ))}
                            </select>
                          </div>
                    ...
                    <div className="space-y-6">
                      ...
                      {studentRestrictions?.isOverdue && (
                        <div className="bg-amber-50/90 border border-amber-200 rounded-2xl p-4 flex flex-col sm:flex-row gap-3 items-start text-xs shadow-sm">
                          ...
                          <div className="space-y-1 flex-1">
                            <h4 className="font-bold text-amber-950 text-xs">⚠️ Outstanding School Fees Past Due Notice</h4>
                      ...
                      <div className="bg-slate-900 p-6 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-white text-xs border border-slate-800">
                        <div className="space-y-1">
                          ...
                          <p className="text-slate-400 font-medium">Class: <span className="font-semibold text-white">{loggedParentStudent.grade}</span> • Room {loggedParentStudent.classSection} • Enrollment: <span className="text-white font-mono">{loggedParentStudent.enrollmentNo || 'ADM-2026-6432'}</span></p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {loggedParentStudent.feeStatements && loggedParentStudent.feeStatements.outstandingBalance > 0 ? (
                              <div className="bg-white p-4 border border-indigo-100 rounded-xl space-y-3 shadow-xs">
                                ...
                                <div className="space-y-2 font-mono">
                                  ...
                                  <input 
                                    type="text"
                                    placeholder="Card details: 4111 8888 •••• ••••"
                                    maxLength={19}
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                                ...
                                <div className="md:col-span-4 bg-violet-900 text-white p-4 rounded-xl flex flex-col items-center justify-center text-center space-y-2 shadow-sm relative overflow-hidden">
                                  ...
                                  <div className="bg-violet-850 px-2 py-0.5 rounded-md text-[9px] font-bold font-sans border border-violet-700">
                                    {parentPunctuality + parentEngagement + studentResponsiveness + academicReadiness >= 32 ? "🌟 High Potential Fit" :
                                     parentPunctuality + parentEngagement + studentResponsiveness + academicReadiness >= 24 ? "👍 Recommended" :
                                     parentPunctuality + parentEngagement + studentResponsiveness + academicReadiness >= 16 ? "⚠️ Conditional Offer" :
                                     "❌ Advisory Suggested"}
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 font-sans">
                              ...
                              <div className="space-y-1.5 font-sans">
                                ...
                                >
                                  <option value="">-- No Template (₦1,500 Base) --</option>
                                  {feeTemplates.map((tpl) => (
                                    <option key={tpl.id} value={tpl.id}>
                                      {tpl.id} ({tpl.branch} - Term {tpl.term.slice(-1)}: ₦{tpl.totalFee?.toLocaleString()})
                                    </option>
                                  ))}
                                </select>
                              </div>
                              ...
                              <tr key={app.id} className="hover:bg-slate-50/50">
                                ...
                                <td className="p-3.5 text-center">
                                  <span className={`inline-block font-mono text-[10px] font-bold px-2.5 py-1 rounded-full ${
                                    ...
                                    {app.status === 'Pre-registered' && '① Pre-Registered'}
                                    {app.status === 'Submitted by Parent' && '② Submitted by Parent (Pending HT)'}
                                    {app.status === 'HT Reviewed' && '③ Reviewed by Principal (Pending Board)'}
                                    {app.status === 'Approved & Allocated' && '④ Officially Approved & Admitted!'}
                                  </span>
                                </td>
                  ...
                  <div className="border-b border-indigo-100 pb-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <div className={`px-3 py-1.5 rounded-xl border flex items-center space-x-2 text-[11px] font-mono font-bold shadow-sm ${
                        ...
                        <span>{securityLockdownMode ? 'SYSTEM LOCKED DOWN ⚠️' : 'All ERP Systems Secured'}</span>
                      </div>
                    ...
                    <div className="bg-rose-650 text-white p-4 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 shadow-md bg-gradient-to-r from-rose-700 to-rose-800 animate-pulse">
                      ...
                      <button 
                        ...
                        onClick={() => {
                          ...
                          alert("🟢 LOCKDOWN TERMINATED: Standard ERP permissions have been successfully restored.");
                        }}
                      ...
                      <div className="xl:col-span-2 bg-white rounded-3xl border border-slate-200 p-5 space-y-4 shadow-sm">
                              ...
                              {systemUsers.map(usr => (
                                <tr key={usr.id} className="hover:bg-slate-50/30 transition-colors">
                                  ...
                                  <td className="p-3.5 text-center font-bold text-slate-800 font-mono text-[10px]">
                                    {usr.branch === 'All' ? '🌐 ALL CAMPUSES' : `${usr.branch} CAMPUS`}
                                  </td>
                                  <td className="p-3.5 text-center">
                                      ...
                                      <button 
                                        ...
                                        onClick={() => {
                                          if (usr.status !== 'Active') {
                                            alert(`❌ ACCESS SUSPENDED: This user credential is marked as "${usr.status}". Please reactivate before simulating.`);
                                            return;
                                          }
                                          ...
                                          alert(`🔑 SIMULATION INITIATED: Successfully assumed simulated administrative login for "${usr.name}" as a "${usr.role}".`);
                                        }}
                        ...
                        <div className="bg-amber-50 border border-amber-200/55 p-4 rounded-2xl text-[11px] text-amber-800 leading-relaxed font-sans">
                          ...
                          <p className="text-amber-800/90 mt-1">
                            SAMS utilizes a fully reactive local sandboxed state. Click any <strong>Simulate Login 🔑</strong> button to instantly adopt that staff member's credentials and branch context. The SAMS sidebar and modules will adapt immediately to reflect their exact access credentials.
                          </p>
                        </div>
                      </div>
                        ...
                        <form 
                          onSubmit={(e) => {
                            ...
                            if (isEditingUser && selectedUser) {
                              ...
                              alert("✨ SUCCESS: Administrative user settings updated correctly.");
                            } else {
                              ...
                              alert("✨ SUCCESS: New administrative credentials registered perfectly.");
                            }
                            setNewUserForm({
                              name: '',
                              email: '',
                        ...
                        >
                          ...
                          <div className="space-y-1.5">
                            ...
                            <select
                              ...
                              className="w-full bg-white border border-slate-200 rounded-xl p-2.5 outline-none cursor-pointer focus:border-rose-500 font-semibold"
                            >
                              <option value="All">🌐 All Campuses (Global Access)</option>
                    ...
                    <div id="editable-matrix-card" className="bg-white rounded-3xl border border-slate-200 p-6 space-y-4 shadow-sm animate-fade-in">
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (confirm("Reset administrative access groups to system default profiles? This overrides customized toggles.")) {
                              ...
                              alert("✨ SUCCESS: SAMS role permission matrices restored successfully.");
                            }
                          }}
                          ...
                          <thead>
                            <tr className="bg-slate-50 border-b border-slate-200 text-[10px] uppercase font-bold text-slate-500 tracking-wider font-mono">
                              ...
                              {[
                                ...
                                { id: 'teachers', label: '💼 HR Portal' },
                                { id: 'payroll', label: '💳 Payroll' },
                                { id: 'classes', label: '🏫 Class Hub' },
                                { id: 'grades', label: '✏️ Gradebook' },
                                { id: 'consolidation', label: '🔒 Consol' },
                                { id: 'scheduler', label: '📅 Schedule' },
                                { id: 'calendar', label: '📆 Calendar' },
                                { id: 'health', label: '❤️ Health' },
                                { id: 'financial_settings', label: '🪙 Finance' },
                                { id: 'assistant', label: '🤖 AI Pilot' },
                      ...
                      <div className="bg-rose-50 border border-rose-150 p-4 rounded-2xl space-y-1 text-rose-950 font-sans">
                        ...
                        <p className="text-[11px] leading-relaxed">
                          SAMS instantly enforces access privileges on the sidebar navigation buttons. If you uncheck a permission module for a role (e.g. unchecking 'Gradebook' for 'Teacher'), simulating that role will immediately lock that tab with a security padlock 🔒 and render an "Access Denied" barrier screen when clicked.
                        </p>
                      </div>
                    </div>
                  )}
                          ...
                          <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2.5">
                            <div className="flex justify-between items-center text-xs">
                              ...
                              <span className={`px-2 py-0.5 rounded-full font-bold text-[10px] uppercase font-mono ${
                                ...
                                {securityLockdownMode ? '🔒 ENGAGED / ISOLATED' : '🔓 DISENGAGED (SECURE)'}
                              </span>
                            </div>
                            ...
                            >
                              {securityLockdownMode ? 'Disengage Lockdown 🔓' : 'Engage Emergency Lockdown ⚠️'}
                            </button>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                            ...
                            <div className="space-y-1.5 font-mono text-[10px]">
                              <div className="flex justify-between items-center">
                                ...
                                <span className="text-emerald-700 font-bold">● Server-Side Only (Hidden)</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span>SSL_ENCRYPTION</span>
                                <span className="text-emerald-700 font-bold">● SHA-256 TLS Active</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span>CONTAINER_PORT</span>
                                <span className="text-indigo-700 font-bold">● Bind 3000 Ingress</span>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <form onSubmit={handleCreateStudent} className="p-6 space-y-4 text-xs font-sans text-slate-700">
              ...
              <div className="space-y-1 bg-emerald-50/35 border border-emerald-150 p-3.5 rounded-xl font-sans">
                <label className="font-bold tracking-widest uppercase text-[9.5px] text-emerald-850 block">
                  🌙 Islamia Wing Enrollment (Optional Program)
                </label>
                <select
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 max-w-2xl w-full overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto space-y-4 text-xs text-slate-700 flex-1 w-full max-w-full">
              <div className="bg-emerald-50 text-emerald-850 p-3.5 rounded-xl border border-emerald-100 leading-relaxed text-[11px] space-y-1">
                <span className="font-bold block text-xs text-emerald-900">💡 Formatting Information:</span>
                <p>
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] pt-1 text-emerald-905">
                  <div>• Nursery 1-3 classes map to: <b className="font-mono text-emerald-900">01, 02, 03</b></div>
                  <div>• Primary 1-6 classes map to: <b className="font-mono text-emerald-900">04, 05, 06, 07, ...</b></div>
                </div>
              </div>
            ...
            <form onSubmit={handleCreateTeacher} className="p-6 space-y-4 text-xs font-sans text-slate-700">
              ...
              {newTeacherForm.role === 'teaching' ? (
                ...
                <div className="bg-amber-50 border border-amber-200/50 p-3 rounded-xl text-[11px] text-amber-800 space-y-1">
                  <p className="font-bold">💼 Non-Teaching/Management Mode</p>
